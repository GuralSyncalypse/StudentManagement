...
- Create Angular project with ng: `ng new luongchihai_qlsv.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`luongchihai_qlsv.client.esproj`).
